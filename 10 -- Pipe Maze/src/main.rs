...
fn can_squeeze(
    ...
    if dir == 'n' && dest != '-' {
        if dest == '|' {
            ret_val = true;
        } else if dest == 'J' && *c_upl == 'L' {
            ret_val = true;
        } else if dest == 'L' && *c_upr == 'J' {
            ret_val = true;
        }
    } else if dir == 's' && dest != '-' {
        if dest == '|' {
            ret_val = true;
        } else if dest == 'F' && *c_dl == '7' {
            ret_val = true;
        } else if dest == '7' && *c_dr == 'F' {
            ret_val = true;
        }
    } else if dir == 'e' && dest != '|' {
        if dest == '-' {
            ret_val = true;
        } else if dest == 'F' && *c_upr == 'L' {
            ret_val = true;
        } else if dest == 'L' && *c_dr == 'F' {
            ret_val = true;
        }
    } else if dir == 'w' && dest != '|' {
        if dest == '-' {
            ret_val = true;
        } else if dest == '7' && *c_upl == 'J' {
            ret_val = true;
        } else if dest == 'J' && *c_dl == '7' {
            ret_val = true;
        }
    } else if dir == '7' && dest != 
    ret_val
